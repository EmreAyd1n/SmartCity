        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Haritadan Seçim */}
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-surface-700 mb-1">Haritadan Konum Seçin</label>
                <p className="text-xs text-surface-500 mb-2">Haritaya tıklayarak tam konumu işaretleyin.</p>
                <LocationPickerMap 
